...
C_DEPS += \
./source/networking/networking.d 

OBJS += \
./source/networking/networking.o 


# Each subdirectory must supply rules for building sources it contributes
source/networking/%.o: ../source/networking/%.c source/networking/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-networking

clean-source-2f-networking:
	-$(RM) ./source/networking/networking.d ./source/networking/networking.o

.PHONY: clean-source-2f-networking
